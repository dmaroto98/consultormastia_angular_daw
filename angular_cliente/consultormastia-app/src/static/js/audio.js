...
audio.src="../../static/mp3/tia.mp3";
audio.addEventListener('ended', function () {
   // Wait 500 milliseconds before next loop
   setTimeout(function () { audio.play(); }, 55000);
 }, false);
audio.play();*/

/*-----------------------------------------------------------------*/
/*------------------- Alerta en caso que el carrusel este vacio no tiene puntos -------------------------*/
function buscarOfertas() {
  if($(".item").length == 0){
    //alert("No existen elementos");
    document.getElementById('cero-puntos').style.display = 'block';
        document.getElementById("MultiCarousel").innerHTML='<img style="width:100%;" src="../../static/img/Banner-no-puntos.png">';
    }
  }


/*######### Este campo hace que se ejecute directo la funcion al cargar la pagina ########*/
...
/*-------------- Filtro si no encuentra valores -------------------*/
